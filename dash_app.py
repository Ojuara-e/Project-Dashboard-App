...
def dash_filtros_sidebar(df):
    ...
    st.sidebar.markdown(
        ...
        <div style="background-color:#00CC96; padding: 10px; border-radius: 5px; text-align: center; margin-bottom: 15px;">
            <h3 style="color:white; margin:0; font-weight:bold;">Projeto Dashboard</h3>
        </div>
        """,
    ...
    st.sidebar.caption("Dashboard Desenvolvido por Ellihas Freitas.")
...
def dash_project():
    ...
    st.title("Dash App - Sales Analytics")
